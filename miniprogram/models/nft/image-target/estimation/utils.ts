export const buildModelViewProjectionTransform = (projectionTransform: number[][], modelViewTransform: number[][]) => {
...
// @ts-ignore
export const applyModelViewProjectionTransform = (modelViewProjectionTransform: number[][], x: number, y: number, z: any) => {
  // assume z is zero
...
export const screenToMarkerCoordinate = (modelViewProjectionTransform: number[][], sx: number, sy: number) => {
