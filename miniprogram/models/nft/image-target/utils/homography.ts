...
export const solveHomography = (srcPoints: number[][], dstPoints: number[][]) => {
...
const _normalizePoints = (coords: number[][]) => {
...
// }
const _denormalizeHomography = (nH: number[], srcParam: { meanX: any; meanY: any; s: any; }, dstParam: { meanX: any; meanY: any; s: any; }) => {
  /*
  Matrix version
